...
class TestTopologyWeightOffRegression:
    def test_match_cluster_score_bit_identical_jaccard_only(self):
        ...
        from noise_gate.domain.correlation import ClusterState, jaccard, match_cluster
...
class TestStlOffRegression:
    async def test_stl_helper_not_called_and_hw_path_when_off(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "noise_gate.infrastructure.metric_stl.stl_anomaly_score", _spy
        )
...
# ═════════════════════════════════════════════════════════════
from noise_gate.domain.annotation_signal import extract_annotation_signal  # noqa: E402
from noise_gate.domain.correlation import extract_site_token  # noqa: E402
from noise_gate.domain.notification_policy import (  # noqa: E402
    TIER_DASHBOARD,

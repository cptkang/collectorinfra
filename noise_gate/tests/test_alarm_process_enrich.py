...
from noise_gate.domain.alarm import AlarmAnalysisResult, ProcessInfo, ProcessSnapshot
...
class TestAnalyzerProcessSection:
    def test_render_process_section(self):
        from noise_gate.application.nodes.alarm_analyzer import _render_process_section
...
class TestProcessApiClient:
    ...
    async def test_hostname_url_encoded(self, monkeypatch):
        import noise_gate.infrastructure.polestar_process_api as mod

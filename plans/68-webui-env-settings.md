...
### A.19 폴스타 실시간 REST (`cfg.polestar_rest` · 5필드) — 2026-08-25 추가(D-163 부기)
| env 키 | 위젯 | 기본값 | 반영 | 비고 |
|---|---|---|---|---|
...
### A.20 DRM 해제 (`cfg.drm` · 9필드) — 2026-08-25 추가(D-163 부기)
| env 키 | 위젯 | 기본값 | 반영 | 비고 |
|---|---|---|---|---|
...
> 어드민 설정 UI에서 보이지 않았다(인덱스 21그룹 vs 응답 19그룹). D-163 부기로 정정 — 이후

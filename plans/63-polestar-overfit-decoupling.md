...
> **상태**: 진행 중 — Step0(선행 커밋 cee7cdf, D-086/D-087 분리) 완료 · **트랙 P1 완료**(D-088 등재, 공용 주입 블록 일반화 — build_prior_rows_block 일반화/build_stat_month_block 폴스타 게이트 대칭/공용 템플릿 예시 중립화/D-085 메시지 중립화, `test_prior_rows_scope.py` 16건 통과·서브셋 594 무회귀·text2sql 109 통과·arch_check --ci error 0) · 다음: P4-1(overfit_check 기준선)

...
> **상태**: 진행 중 — Step0(선행 커밋 cee7cdf) 완료 · **P1 완료**(affca22, D-088 — 공용 주입 블록 일반화; test_prior_rows_scope 16건·전체 pytest 무회귀[클린 vs post-P1 FAILED 집합 동일]·text2sql 109·arch_check error 0·EX 3경로 DB미접속 각 26 skip) · **P4-1 완료**(D-088 확장 — `scripts/overfit_check.py`+기준선 71토큰/13파일+스킬 등록, `test_overfit_check.py` 6건·overfit_check --ci exit 0) · 다음: P2(어댑터 이동)

...
```
┌─ requirements-analyst (background) ──→ docs/requirements.md
│
...
**실행 절차**:
1. `docs/decision.md`를 읽고 기존 결정 사항을 확인합니다.
...
## 의사결정 관리 프로토콜 (`docs/decision.md`)

### 작업 전 (필수)
1. `docs/decision.md`를 읽고 기존 결정 사항(D-001 ~ 최신)을 확인합니다.
...
### 작업 후 (필수)
1. 작업 중 새로운 의사결정이 발생하면 `docs/decision.md`에 추가합니다.
...
- 아키텍처 결정 기록: docs/decision.md — **변경 전 참조, 변경 후 갱신**
